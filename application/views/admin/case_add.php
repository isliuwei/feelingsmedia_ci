...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">案例新增界面</strong> / <small>Add Case</small></div>
        </div>
        ...
        <div class="am-tabs am-margin" data-am-tabs>
            ...
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    <form action="admin/save_case" method="post" class="am-form am-form-inline" enctype="multipart/form-data">


                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-2 am-text-right">案例主标题</div>
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="text" id="case-mainTitle" name="case_mainTitle"  >
                            </div>
                        </div>
                        <div class="am-g am-margin-top">
                            <div class="am-u-sm-4 am-u-md-2 am-text-right">案例副标题</div>
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="text" id="case-subTitle" name="case_subTitle" >
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="text" id="case-cate" name="case_cate" >
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="text" id="case-desc" name="case_desc" >
                            </div>
                        </div>
                         ...
                         <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                                <input type="text" id="case-time" name="case_time" >
                            </div>
                        </div>
                        ...
                        <div class="am-g am-margin-top">
                            ...
                            <div class="am-u-sm-8 am-u-md-4 am-u-end">
                               <textarea name="case_content" id="case-content" cols="30" rows="10">在此输入案例内容</textarea>
                            </div>
                        </div>
