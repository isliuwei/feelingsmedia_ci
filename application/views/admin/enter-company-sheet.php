...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">媒体公司信息录入界面</strong> / <small>Add Company</small></div>
        </div>
...
<form class="am-form am-form-horizontal" action="admin/save_enter_company_info" method="post" enctype="multipart/form-data">
...
<div class="am-form-group">
    ...
    <input  name="company_username" type="text" id="doc-ipt-3">
    </div>
</div>
...
<div class="am-form-group">
    ...
    <div class="am-u-sm-10">
    <input  name="company_email" type="email" id="doc-ipt-3">
    </div>
</div>
...
<div class="am-form-group">
    ...
    <div class="am-u-sm-10">
      <input name="company_password" type="text" id="doc-ipt-pwd-2">
    </div>
</div>
...
<div class="am-form-group">
    ...
    <div class="am-u-sm-10">
      <input name="company_tel" type="number" id="doc-ipt-3">
    </div>
</div>
...
<div class="am-form-group">
    ...
    <div class="am-u-sm-10">
      <input name="company_name" type="text" id="doc-ipt-3">
    </div>
</div>
...
<div class="am-form-group">
    ...
    <div class="am-u-sm-10">
      <input name="company_website" type="text" id="doc-ipt-3">
    </div>
</div>
...
<div class="am-form-group">
  <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">公司资源类型</label>
  <div class="am-u-sm-10">
...
<div class="am-form-group">
    <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">公司资源分布城市</label>
    <div class="am-u-sm-10">
