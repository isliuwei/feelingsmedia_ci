      ...
      ?>
        <div class="panel panel-success col-md-3 col-md-offset-1">
          ...
          <div class="panel-body">
            ...
            <p class="search" data-toggle="modal" data-target="#anchorNeed<?php echo $anchorNeed -> anchorNeed_id; ?>">
              <i class="fa fa-search"></i> 查看详情
            </p>
          </div>
          <div class="panel-footer"><i class="fa fa-calendar"></i>发布时间：<?php echo $anchorNeed -> add_time ?></div>
        </div>

        <div class="modal fade" id="anchorNeed<?php echo $anchorNeed -> anchorNeed_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <div class="input-group col-md-11">
                    ...
                    <input type="text"  class="form-control"  aria-describedby="aderBrand" value="<?php echo $anchorNeed -> anchorNeed_brand;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="aderPro"><i class="fa fa-briefcase"></i> 广告主宣传产品 <i class="fa fa-asterisk"></i></span>
                    <input type="text" class="form-control"  aria-describedby="aderPro" value="<?php echo $anchorNeed -> anchorNeed_pro;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="anchorCate"><i class="fa fa-connectdevelop"></i> 广告主行业 <i class="fa fa-asterisk"></i></span>
                    <input type="text" class="form-control"  aria-describedby="aderPro" value="<?php echo $anchorNeed -> anchorNeed_aderCates;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="aderTime"><i class="fa fa-clock-o"></i> 预计投放时间 <i class="fa fa-asterisk"></i></span>
                    <input type="text" class="form-control" aria-describedby="aderTime" value="<?php echo $anchorNeed -> anchorNeed_time;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="aderCycle"><i class="fa fa-calendar-check-o"></i> 预计投放周期</span>
                    <input type="text" class="form-control"  aria-describedby="aderCycle" value="<?php echo $anchorNeed -> anchorNeed_cycle;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="anchorNum"><i class="fa fa-users"></i> 需要主播数量</span>
                    <input type="text" class="form-control"  aria-describedby="anchorNum" value="<?php echo $anchorNeed -> anchorNeed_number;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="anchorCate"><i class="fa fa-navicon"></i> 要求主播行业 <i class="fa fa-asterisk"></i></span>
                    <input type="text" class="form-control"  aria-describedby="anchorCate" value="<?php echo $anchorNeed -> anchorNeed_anchorCates;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="fansNum"><i class="fa fa-smile-o"></i> 要求主播粉丝量 <i class="fa fa-asterisk"></i></span>
                    <input type="text" class="form-control"  aria-describedby="fansNum" value="<?php echo $anchorNeed -> anchorNeed_fansNumber;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="CoopCate"><i class="fa fa-comments-o"></i> 希望主播合作形式</span>
                    <input type="text" class="form-control"  aria-describedby="CoopCate" value="<?php echo $anchorNeed -> anchorNeed_coopCate;?>">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group col-md-11">
                    <span class="input-group-addon" id="otherNeed"><i class="fa fa-file-text-o"></i> 其他需求</span>
                    <textarea class="form-control" rows="6" aria-describedby="otherNeed"><?php echo $anchorNeed -> anchorNeed_otherNeed;?></textarea>
                  </div>
                </div>
              </fieldset>
              </div>
