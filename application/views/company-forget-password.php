...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <form action="company/find_password" method="post" class="form-horizontal col-md-9 col-md-offset-1" name="findForm">
  ...
  $userInput.on('blur',function(){
    var $username = $userInput.val().trim();
      if($username==""){
        ...
        $.get('company/check_company_username',{username:$username},function(result){
            if(result=='fail'){
                $userInput.val('');
