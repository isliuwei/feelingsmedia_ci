...
<div id="js-alert-box" class="alert-box"> <svg class="alert-circle" width="234" height="234">
  ...
  <div class="alert-body">
    ...
    <a id="js-alert-btn" class="alert-btn" href="ader/anchor_need_profile/<?php echo $ader_id ?>">立即前往需求列表</a> </div>
...
function alertSet(e) {
    ...
    setInterval(function() {
        if (0 == t){
			location.href="ader/anchor_need_profile/<?php echo $ader_id ?>";//#时间到后跳转地址
		}else {
            t -= 1,
            document.getElementById("js-sec-text").innerHTML = t;
